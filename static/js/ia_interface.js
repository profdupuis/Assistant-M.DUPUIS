      ...
      btn.classList.add('reported');
       btn.disabled = true;              // bloque le clic
          ...
          btn.classList.add('used');
            ...
            const hiddenPrompt = `Propose un exercice du même type que celui que l’élève vient de faire, en gardant le même format (🧩 EXERCICE N, niveau x, LaTeX, etc.).
            ...
            const systemPrompt = `Évalue discrètement si la réponse de l’élève permet de conclure l’exercice en cours et ce n'est valable que pour les exercices de la fiche, pas ceux que tu inventes.  
